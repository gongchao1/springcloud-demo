...
/**
 * mybatis-plus代码生成器
 * Created by wangheduo on 2018/4/3
 */
public class MpGenerator {
    ...
    private static void shell(String model){
        ...
        dsc.setPassword("123");
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/mytest?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
        ...
        strategy.setInclude(new String[] { "sys_user","sys_role","sys_authority","sys_role_authority","sys_user_role" }); // 需要生成的表
